...
CREATE TABLE `bang_diem` (
  ...
  KEY `ma_mon_hoc_idx` (`ma_hoc_sinh`),
  CONSTRAINT `ma_hoc_sinh` FOREIGN KEY (`ma_hoc_sinh`) REFERENCES `hoc_sinh` (`ma_hoc_sinh`),
  CONSTRAINT `ma_mon_hoc` FOREIGN KEY (`ma_hoc_sinh`) REFERENCES `mon_hoc` (`ma_mon_hoc`)
...
-- Dump completed on 2022-11-25 11:18:27
